...
# fit LSTM
X, y = generate_data(100000, n_terms, largest, alphabet)
X_val, y_val = generate_data(10000, n_terms, largest, alphabet)
history = model.fit(X, y,validation_data=(X_val, y_val), epochs=50, batch_size=512)

...
N_ite = 1000                          # Nombre d'iterations de l'algorithme d'entrainement
    ...
    for n_exe in range(0,N_exemples):
        ...
        for n_neurone in range(0,N):
            for n_sortie in range(0,Ns):
                delta_V[n_neurone] = delta_V[n_neurone] + Sv[n_neurone]*(1-Sv[n_neurone])*delta_W[n_sortie]*W[n_sortie,n_neurone] # *... terme correcteur de la couche cachee
        ...
        for n_neurone in range(0,Ns):
            for n_entree in range(0,N):
                W[n_neurone,n_entree] = W[n_neurone,n_entree]+ alpha*delta_W[n_neurone]*Sv[n_entree] # + alpha*...
